...
class ClassificationTool:
    def __init__(self, classification_path):
        ...
        self.class_names =  ['library stamps', 'misaligned', 'multiple images', 'not images', 'ok', 'too big', 'too small']
        self.big_model = self._load_model_vgg19(r'.\model\torch_model_vgg19_ext_cntr_7cl_more_data2_label_smoothing05.pt', 7)
